Shader "Unreal/M_Sky_01"
{
    Properties
    {
		...
		Material_TextureCube_0( "HDRI", Cube ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		SkyRotation( "SkyRotation", Float ) = 1.000000
		EmissiveScale( "EmissiveScale", Float ) = 1.000000
		HDR_Power( "HDR_Power", Float ) = 1.000000
