Shader "Unreal/M_Lake"
{
    Properties
    {
		...
		Normal_Speed( "Normal_Speed", Float ) = 0.250000
		Normal_Tiling( "Normal_Tiling", Float ) = 5000.000000
		NormalStrength( "NormalStrength", Float ) = 0.000000
		Normal_Tiling__Distance( "Normal_Tiling__Distance", Float ) = 5000.000000
		NormalStrength_Distance( "NormalStrength_Distance", Float ) = 0.000000
		FarDistanceTexture( "FarDistanceTexture", Float ) = 1200.000000
		WaterColor_Deep( "WaterColor_Deep", Color ) = (0.026241, 0.034340, 0.051269, 1.000000 )
		WaterColor_Shallow( "WaterColor_Shallow", Color ) = (0.051269, 0.037972, 0.018365, 1.000000 )
		WaterColor_Distance( "WaterColor_Distance", Float ) = 128.000000
		Foam_Speed( "Foam_Speed", Float ) = 0.500000
		Foam_Tiling( "Foam_Tiling", Float ) = 2048.000000
		FoamAmount( "FoamAmount", Float ) = 1.000000
		Foam_Distance( "Foam_Distance", Float ) = 128.000000
		ColorBrightness( "ColorBrightness", Float ) = 1.000000
		Metallic( "Metallic", Float ) = 0.000000
		Specular_1( "Specular_1", Float ) = 0.000000
		Roughness( "Roughness", Float ) = 0.000000
		Opacity( "Opacity", Float ) = 1.000000
		FadeDistance( "FadeDistance", Float ) = 0.000000
