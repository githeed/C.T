Shader "Unreal/M_Master_Props_Masked"
{
    Properties
    {
		...
		Material_Texture2D_2( "Specular_Roughness_Metallic", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		FlattenNormal( "FlattenNormal", Float ) = 0.000000
		Brightness( "Brightness", Float ) = 1.000000
		BaseColor_Desaturation( "BaseColor_Desaturation", Float ) = 0.000000
		Specular_Control( "Specular_Control", Float ) = 1.000000
		Roughness_Control( "Roughness_Control", Float ) = 1.000000
    ...
    SubShader
    {
        ...
        #include "M_Master_Props_Masked.hlsl"
