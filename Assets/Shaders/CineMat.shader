Shader "Unreal/CineMat"
{
    Properties
    {
		...
		Base_Color( "Base_Color", Color ) = (0.043137, 0.043137, 0.043137, 0.000000 )
		Specular_13( "Specular_13", Float ) = 0.300000
		Roughness( "Roughness", Float ) = 0.200000
