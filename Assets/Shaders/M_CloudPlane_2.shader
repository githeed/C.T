Shader "Unreal/M_CloudPlane_2"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Cloud_BC", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Albedo_Contrast( "Albedo_Contrast", Float ) = 1.000000
		Speed( "Speed", Float ) = 0.000000
		Albedo_Tiling( "Albedo_Tiling", Float ) = 1.000000
		Albedo_Intensity( "Albedo_Intensity", Float ) = 1.000000
		AlbedoColor( "AlbedoColor", Color ) = (1.000000, 1.000000, 1.000000, 0.000000 )
		MaskRadius( "MaskRadius", Float ) = 0.333333
		MaskDensity( "MaskDensity", Float ) = 1.000000
		FadeDistance( "FadeDistance", Float ) = 0.000000
		Fog_Intensity( "Fog_Intensity", Float ) = 1.000000
