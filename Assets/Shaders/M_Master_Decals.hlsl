...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.395833,0.395833,0.395833,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.500000,1.000000,0.000000,0.000000);//(Unknown)

	Material.PreshaderBuffer[0].x = Normals_Strength;
	Material.PreshaderBuffer[0].y = SelectionColor.w;
	Material.PreshaderBuffer[1].xyz = SelectionColor.xyz;
	Material.PreshaderBuffer[2].xyz = Decal_Tint.xyz;
	Material.PreshaderBuffer[2].w = SpecularStrength;
	Material.PreshaderBuffer[3].x = Roughness_Strength;
	Material.PreshaderBuffer[3].y = Opacity;
	Material.PreshaderBuffer[3].z = RefractionDepthBias;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local4 = (MaterialFloat3(MaterialFloat2(Local2.r,Local2.g),Local2.b).rg * ((MaterialFloat2)Material.PreshaderBuffer[0].x));

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = MaterialFloat3(Local4,MaterialFloat3(MaterialFloat2(Local2.r,Local2.g),Local2.b).b);
	...
	MaterialFloat Local10 = (1.00000000 - Local2.a);
	MaterialFloat Local11 = (Local10 * Material.PreshaderBuffer[2].w);
	MaterialFloat Local12 = (Local2.a * Material.PreshaderBuffer[3].x);
	MaterialFloat Local13 = (Local7.a * Material.PreshaderBuffer[3].y);
	...
	PixelMaterialInputs.Specular = Local11;
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat3(1.00000000,0.00000000,0.00000000).xy,Material.PreshaderBuffer[3].z);
