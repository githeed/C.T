Shader "Unreal/MI_Canvas"
{
    Properties
    {
		...
		Color_5( "Color_5", Color ) = (0.097375, 0.098958, 0.071298, 0.000000 )
		...
		SpecularValue( "SpecularValue", Float ) = 2.237881
		Roughness( "Roughness", Float ) = 0.800000
		SS_Int( "SS_Int", Float ) = 0.600000
