...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,0.133333,0.476190,0.000000);//(Unknown)

	Material.PreshaderBuffer[0].x = SelectionColor.w;
	Material.PreshaderBuffer[0].yzw = SelectionColor.xyz;
	Material.PreshaderBuffer[1].x = Specular_2;
	Material.PreshaderBuffer[1].y = Roughness;
	Material.PreshaderBuffer[1].z = Opacity;
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Opacity = Material.PreshaderBuffer[1].z;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = MaterialFloat3(0.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Metallic = 0.00000000;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[1].x;
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[1].y;
