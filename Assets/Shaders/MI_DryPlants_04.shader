Shader "Unreal/MI_DryPlants_04"
{
    Properties
    {
		...
		ColorTint( "ColorTint", Color ) = (1.000000, 0.794243, 0.574826, 0.000000 )
		ColorBrightness( "ColorBrightness", Float ) = 1.000000
		Desaturation( "Desaturation", Float ) = 0.100000
		RoughnessInt( "RoughnessInt", Float ) = 1.000000
		Specular_16( "Specular_16", Float ) = 1.000000
		SS_Amount( "SS_Amount", Float ) = 0.200000
		OpacityInt( "OpacityInt", Float ) = 3.000000
		SSBrightness( "SSBrightness", Float ) = 4.000000
