Shader "Unreal/M_Master_Decals"
{
    Properties
    {
		...
		Material_Texture2D_0( "Normal_AO_Roughness", 2D ) = "white" {}
		Material_Texture2D_1( "BaseColor", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Normals_Strength( "Normals_Strength", Float ) = 1.000000
		Decal_Tint( "Decal_Tint", Vector ) = (0.395833, 0.395833, 0.395833, 0.000000 )
		SpecularStrength( "SpecularStrength", Float ) = 0.000000
		Roughness_Strength( "Roughness_Strength", Float ) = 1.500000
