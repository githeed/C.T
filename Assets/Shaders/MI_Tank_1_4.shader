Shader "Unreal/MI_Tank_1_4"
{
    Properties
    {
		...
		Color_4( "Color_4", Color ) = (0.192708, 0.192708, 0.192708, 0.000000 )
		Tint( "Tint", Vector ) = (0.424196, 0.427083, 0.243871, 0.000000 )
		Brightness( "Brightness", Float ) = 1.000000
		MetalicAmount( "MetalicAmount", Float ) = 0.000000
		SpecularValue( "SpecularValue", Float ) = 2.000000
