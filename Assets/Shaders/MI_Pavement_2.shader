Shader "Unreal/MI_Pavement_2"
{
    Properties
    {
		...
		Material_Texture2D_1( "Soil_01_N", 2D ) = "white" {}
		Material_Texture2D_2( "Soil_01_D", 2D ) = "white" {}
		Material_Texture2D_3( "T_Puddle_D", 2D ) = "white" {}
		Material_Texture2D_4( "BaseColor", 2D ) = "white" {}
		Material_Texture2D_5( "T_WallMask_RGB", 2D ) = "white" {}
		Material_Texture2D_6( "SpecMetalRough", 2D ) = "white" {}
		Material_Texture2D_7( "T_Puddle_S", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Tiling( "Tiling", Float ) = 1.000000
		NormalStrength( "NormalStrength", Float ) = 1.000000
		Tiling_Soil_01( "Tiling_Soil_01", Float ) = 200.000000
		Soil_01_NormalStrength( "Soil_01_NormalStrength", Float ) = 2.000000
		Tiling_Puddle_02( "Tiling_Puddle_02", Float ) = 500.000000
		Puddle_02_Desaturation( "Puddle_02_Desaturation", Float ) = 1.000000
		Puddle_02_Brightness( "Puddle_02_Brightness", Float ) = 5.000000
		Tint( "Tint", Vector ) = (0.333333, 0.318735, 0.293744, 0.000000 )
		MetalicAmount( "MetalicAmount", Float ) = 1.000000
		Puddle_02_Specular( "Puddle_02_Specular", Float ) = 5.000000
		Puddle_02_Roughness( "Puddle_02_Roughness", Float ) = 0.500000
