Shader "Unreal/MI_SphericalTank_2"
{
    Properties
    {
		...
		Tiling( "Tiling", Float ) = 0.200000
		NormalStrength( "NormalStrength", Float ) = 5.000000
		Tint( "Tint", Vector ) = (0.583333, 0.583333, 0.583333, 1.000000 )
    ...
    SubShader
    {
        ...
        #include "MI_SphericalTank_2.hlsl"
