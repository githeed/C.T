Shader "Unreal/MI_DryPlants_01"
{
    Properties
    {
		...
		NormalStrength( "NormalStrength", Float ) = 15.000000
		U_Offset( "U_Offset", Float ) = 0.000000
		V_Offset( "V_Offset", Float ) = 0.000000
		ColorTint( "ColorTint", Color ) = (0.882273, 1.000000, 0.684734, 0.000000 )
		ColorBrightness( "ColorBrightness", Float ) = 1.507330
		Desaturation( "Desaturation", Float ) = 0.104762
		RoughnessInt( "RoughnessInt", Float ) = 1.000000
		Specular_20( "Specular_20", Float ) = 1.000000
		SS_Amount( "SS_Amount", Float ) = 0.666667
		OpacityInt( "OpacityInt", Float ) = 5.000000
		SSBrightness( "SSBrightness", Float ) = 2.000000
		__SubsurfaceProfile( "__SubsurfaceProfile", Float ) = -1.000000
		AO( "AO", Float ) = 3.000000
