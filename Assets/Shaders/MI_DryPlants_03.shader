Shader "Unreal/MI_DryPlants_03"
{
    Properties
    {
		...
		ColorTint( "ColorTint", Color ) = (0.205706, 0.312500, 0.168019, 1.000000 )
		ColorBrightness( "ColorBrightness", Float ) = 3.000000
		Desaturation( "Desaturation", Float ) = 0.000000
		RoughnessInt( "RoughnessInt", Float ) = 1.000000
		Specular_21( "Specular_21", Float ) = 1.000000
		SS_Amount( "SS_Amount", Float ) = 0.879493
		OpacityInt( "OpacityInt", Float ) = 5.000000
		SSBrightness( "SSBrightness", Float ) = 3.000000
