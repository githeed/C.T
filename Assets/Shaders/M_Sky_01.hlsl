...
{
	Material.PreshaderBuffer[0] = float4(6.283185,1.000000,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)

	Material.PreshaderBuffer[0].x = SkyRotation * 6.283;
	Material.PreshaderBuffer[0].y = EmissiveScale;
	Material.PreshaderBuffer[0].z = HDR_Power;
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local2 = RotateAboutAxis(MaterialFloat4(MaterialFloat3(0.00000000,0.00000000,1.00000000).rgb,Material.PreshaderBuffer[0].x),WSPromote(((MaterialFloat3)0.00000000)),DERIV_BASE_VALUE(Local1));
	FWSVector3 Local3 = WSAdd(Local2, DERIV_BASE_VALUE(Local1));
	MaterialFloat3 Local4 = WSNormalizeDemote(Local3);
	MaterialFloat Local5 = MaterialStoreTexCoordScale(Parameters, Local4, 0);
	MaterialFloat4 Local6 = ProcessMaterialLinearColorTextureLookup(TextureCubeSample(Material_TextureCube_0,samplerMaterial_TextureCube_0,Local4));
	...
	MaterialFloat3 Local9 = PositiveClampedPow(Local8,((MaterialFloat3)Material.PreshaderBuffer[0].z));
	MaterialFloat3 Local10 = lerp(Local9,Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[0].w);
