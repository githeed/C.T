Shader "Unreal/MI_Asphalt_Road"
{
    Properties
    {
		...
		Soil_01_NormalStrength( "Soil_01_NormalStrength", Float ) = 4.000000
		...
		NormalFlatten( "NormalFlatten", Float ) = -2.683228
