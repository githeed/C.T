Shader "Unreal/M_Master_Mountain"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Mountain_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_MountainDetail_N", 2D ) = "white" {}
		Material_Texture2D_2( "T_MountainDetail_BC", 2D ) = "white" {}
		Material_Texture2D_3( "BC", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		NormalStrength( "NormalStrength", Float ) = 1.000000
		DetailNormalTiling( "DetailNormalTiling", Float ) = 3.000000
		NormalStrengthDetail( "NormalStrengthDetail", Float ) = 1.000000
		DetailAlbedoTiling( "DetailAlbedoTiling", Float ) = 3.000000
		Brightness( "Brightness", Float ) = 1.000000
		Contrast( "Contrast", Float ) = 0.000000
		Saturation( "Saturation", Float ) = 0.000000
    ...
    SubShader
    {
        ...
        #include "M_Master_Mountain.hlsl"
