Shader "Unreal/MI_Poplar_08"
{
    Properties
    {
		...
		Material_Texture2D_2( "O", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		NormalStrength( "NormalStrength", Float ) = -500.000000
		Tint( "Tint", Vector ) = (0.729167, 0.729167, 0.729167, 0.000000 )
		BC_Brightness( "BC_Brightness", Float ) = 1.000000
		Alpha_1( "Alpha_1", Float ) = 0.100000
		Alpha_2( "Alpha_2", Float ) = 0.100000
		OpacityInt( "OpacityInt", Float ) = 2.000000
		OpacityPov( "OpacityPov", Float ) = 12.000000
		SS_Brightness( "SS_Brightness", Float ) = 2.000000
