Shader "Unreal/MM_OilDrill_Trim"
{
    Properties
    {
		...
		Material_Texture2D_1( "Dirt_Normal", 2D ) = "white" {}
		Material_Texture2D_2( "Dirt_Oil_Masks", 2D ) = "white" {}
		Material_Texture2D_3( "T_Default_N", 2D ) = "white" {}
		Material_Texture2D_4( "Albedo", 2D ) = "white" {}
		Material_Texture2D_5( "RGBA", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		NormalIntensity( "NormalIntensity", Float ) = 1.200000
		DirtNormalIntensity( "DirtNormalIntensity", Float ) = 1.200000
		DirtMaskIntensity( "DirtMaskIntensity", Float ) = 1.000000
		DirtMaskContrast( "DirtMaskContrast", Float ) = 1.000000
		OilMaskIntensity( "OilMaskIntensity", Float ) = 1.000000
		OilMaskContrast( "OilMaskContrast", Float ) = 1.000000
		SVC( "SVC", Vector ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		Tint( "Tint", Vector ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		DirtAlbedo( "DirtAlbedo", Vector ) = (0.067708, 0.061064, 0.014385, 1.000000 )
		Dirt_SVC( "Dirt_SVC", Vector ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		Dirt_Tint( "Dirt_Tint", Vector ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		Oil_Albedo( "Oil_Albedo", Vector ) = (0.020833, 0.020833, 0.020833, 1.000000 )
		Oil_SVC( "Oil_SVC", Vector ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		Oil_Tint( "Oil_Tint", Vector ) = (1.000000, 1.000000, 1.000000, 1.000000 )
		SpecularIntensity( "SpecularIntensity", Float ) = 1.000000
		Roughness_Strength( "Roughness_Strength", Float ) = 1.000000
		Roughness_Contrast( "Roughness_Contrast", Float ) = 1.000000
		Dirt_Roughness_Strength( "Dirt_Roughness_Strength", Float ) = 1.000000
		Oil_Roughness_Strength( "Oil_Roughness_Strength", Float ) = 1.000000
