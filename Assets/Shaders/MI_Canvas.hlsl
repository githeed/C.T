...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.097375,0.098958,0.071298,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(1.000000,1.000000,1.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.000000,2.237881,0.800000,0.600000);//(Unknown)
	...
	Material.PreshaderBuffer[2].xyz = Color_5.xyz;
	Material.PreshaderBuffer[3].xyz = Tint.xyz;
	Material.PreshaderBuffer[3].w = Brightness;
	Material.PreshaderBuffer[4].x = MetalicAmount;
	Material.PreshaderBuffer[4].y = SpecularValue;
	Material.PreshaderBuffer[4].z = Roughness;
	Material.PreshaderBuffer[4].w = SS_Int;
	Material.PreshaderBuffer[5].x = __SubsurfaceProfile;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 3);
	...
	MaterialFloat3 Local13 = lerp(Local8.rgb,Material.PreshaderBuffer[2].xyz,Local11.g);
	MaterialFloat3 Local14 = (Local13 * Material.PreshaderBuffer[3].xyz);
	MaterialFloat3 Local15 = (Local14 * ((MaterialFloat3)Material.PreshaderBuffer[3].w));
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local17 = Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local18 = MaterialStoreTexSample(Parameters, Local17, 0);
	MaterialFloat Local19 = (Local17.g * Material.PreshaderBuffer[4].x);
	MaterialFloat Local20 = (Local17.r * Material.PreshaderBuffer[4].y);
	MaterialFloat Local21 = (Local17.b * Material.PreshaderBuffer[4].z);
	MaterialFloat3 Local22 = (Local15 * ((MaterialFloat3)Material.PreshaderBuffer[4].w));
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local22,Material.PreshaderBuffer[5].x);
