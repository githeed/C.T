...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[0].x = NormalInt;
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local12 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 0);
	MaterialFloat Local14 = (Local7.a * Material.PreshaderBuffer[3].x);
	...
	PixelMaterialInputs.Specular = Local12.r;
	PixelMaterialInputs.Roughness = Local12.b;
