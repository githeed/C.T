...
{
	Material.PreshaderBuffer[0] = float4(1.200000,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[1].w = 1 - SVC.x;
	Material.PreshaderBuffer[2].x = SVC.y;
	Material.PreshaderBuffer[2].yzw = Tint.xyz;
	Material.PreshaderBuffer[3].x = SVC.z;
	Material.PreshaderBuffer[3].y = SpecularIntensity;
	Material.PreshaderBuffer[3].z = Roughness_Strength;
	Material.PreshaderBuffer[3].w = Roughness_Contrast;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local10 = lerp(Local7.rgb,((MaterialFloat3)Local9),Material.PreshaderBuffer[1].w);
	MaterialFloat3 Local11 = (Local10 * ((MaterialFloat3)Material.PreshaderBuffer[2].x));
	MaterialFloat3 Local12 = (Local11 * Material.PreshaderBuffer[2].yzw);
	MaterialFloat3 Local13 = PositiveClampedPow(Local12,((MaterialFloat3)Material.PreshaderBuffer[3].x));
	...
	MaterialFloat Local17 = (Local15.r * Material.PreshaderBuffer[3].y);
	MaterialFloat Local18 = lerp(Local17,0.50000000,Local15.g);
	MaterialFloat Local19 = (Local15.b * Material.PreshaderBuffer[3].z);
	...
	PixelMaterialInputs.Metallic = Local15.g;
