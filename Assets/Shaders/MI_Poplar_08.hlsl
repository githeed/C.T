...
uniform float4 Tint;
uniform float BC_Brightness;
uniform float Alpha_1;
uniform float Alpha_2;
uniform float OpacityInt;
uniform float OpacityPov;
uniform float SS_Brightness;
...
{
	Material.PreshaderBuffer[0] = float4(-500.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.729167,0.729167,0.729167,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.100000,0.100000,2.000000,12.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(2.000000,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[2].w = BC_Brightness;
	Material.PreshaderBuffer[3].x = Alpha_2;
	Material.PreshaderBuffer[3].y = Alpha_1;
	Material.PreshaderBuffer[3].z = OpacityInt;
	Material.PreshaderBuffer[3].w = OpacityPov;
	Material.PreshaderBuffer[4].x = SS_Brightness;
	Material.PreshaderBuffer[4].y = __SubsurfaceProfile;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[0].y);
	...
	MaterialFloat3 Local9 = (Local7.rgb * Material.PreshaderBuffer[2].xyz);
	MaterialFloat3 Local10 = (Local9 * ((MaterialFloat3)Material.PreshaderBuffer[2].w));
	...
	MaterialFloat Local14 = dot(Parameters.TangentToWorld[2],Parameters.CameraVector);
	MaterialFloat Local15 = abs(Local14);
	MaterialFloat Local16 = lerp(Material.PreshaderBuffer[3].y,Material.PreshaderBuffer[3].x,Local12.r);
	MaterialFloat Local17 = PositiveClampedPow(Local15,Local16);
	MaterialFloat Local18 = (Local12.r * Local17);
	MaterialFloat Local19 = (Local18 * Material.PreshaderBuffer[3].z);
	MaterialFloat Local20 = PositiveClampedPow(Local19,Material.PreshaderBuffer[3].w);
	MaterialFloat3 Local21 = (Local9 * ((MaterialFloat3)Material.PreshaderBuffer[4].x));

	PixelMaterialInputs.EmissiveColor = Local5;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local20;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local21,Material.PreshaderBuffer[4].y);
