Shader "Unreal/MI_CoolingFan_2"
{
    Properties
    {
		...
		Material_Texture2D_3( "SpecMetalRough", 2D ) = "white" {}
		...
		Color_11( "Color_11", Color ) = (0.067112, 0.067708, 0.025715, 0.000000 )
		Tint( "Tint", Vector ) = (1.000000, 1.000000, 1.000000, 0.000000 )
		Brightness( "Brightness", Float ) = 1.000000
		MetalicAmount( "MetalicAmount", Float ) = 0.000000
		SpecularValue( "SpecularValue", Float ) = 1.000000
		Roughness( "Roughness", Float ) = 1.000000
		OpacityInt( "OpacityInt", Float ) = 1.000000
