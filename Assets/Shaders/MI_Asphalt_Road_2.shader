Shader "Unreal/MI_Asphalt_Road_2"
{
    Properties
    {
		...
		Material_Texture2D_0( "Soil_01_N", 2D ) = "white" {}
		Material_Texture2D_1( "AsphaltPatch_Normal", 2D ) = "white" {}
		Material_Texture2D_2( "Normal", 2D ) = "white" {}
		Material_Texture2D_3( "Mask Texture", 2D ) = "white" {}
		Material_Texture2D_4( "RoadBlendMask", 2D ) = "white" {}
		Material_Texture2D_5( "Soil_01_D", 2D ) = "white" {}
		Material_Texture2D_6( "Base Color", 2D ) = "white" {}
		Material_Texture2D_7( "Soil_01_SMR", 2D ) = "white" {}
		Material_Texture2D_8( "Disp_Rough_Occ", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Tiling_Soil_01( "Tiling_Soil_01", Float ) = 400.000000
		Soil_01_NormalStrength( "Soil_01_NormalStrength", Float ) = -0.480000
		Mask_Size( "Mask_Size", Float ) = 1513.148560
		AsphaltPatch_NormalFlatness( "AsphaltPatch_NormalFlatness", Float ) = 2.579844
		AsphaltPatch_Detail_NormalFlatness( "AsphaltPatch_Detail_NormalFlatness", Float ) = -0.471057
		NormalFlatten( "NormalFlatten", Float ) = -2.000000
		Mask_Intensity( "Mask_Intensity", Float ) = 1.000000
		Mask_Power( "Mask_Power", Float ) = -0.043153
		MaskPower( "MaskPower", Float ) = 2.005331
		MaskInt( "MaskInt", Float ) = 1.000000
		AsphaltPatchColor( "AsphaltPatchColor", Float ) = 0.651632
		Roughness( "Roughness", Float ) = 1.000000
		SpecularInt( "SpecularInt", Float ) = 0.123810
		AsphaltPatch_Roughness( "AsphaltPatch_Roughness", Float ) = 0.668736
		PDO( "PDO", Float ) = 33.359142
    ...
    SubShader
    {
        ...
        #include "MI_Asphalt_Road_2.hlsl"
