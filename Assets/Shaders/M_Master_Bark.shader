Shader "Unreal/M_Master_Bark"
{
    Properties
    {
		...
		Material_Texture2D_0( "NAOR_1", 2D ) = "white" {}
		Material_Texture2D_1( "T_BarkMask_Mask", 2D ) = "white" {}
		Material_Texture2D_2( "BCO_1", 2D ) = "white" {}
		Material_Texture2D_3( "BCO_2", 2D ) = "white" {}
		Material_Texture2D_4( "NAOR_2", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		NormalStrength_1( "NormalStrength_1", Float ) = -5.000000
		MaskSize( "MaskSize", Float ) = 1.000000
		Tiling_1( "Tiling_1", Float ) = 1.000000
		ColorTint_1( "ColorTint_1", Color ) = (1.000000, 1.000000, 1.000000, 0.000000 )
		ColorBrightness_1( "ColorBrightness_1", Float ) = 1.000000
		Desaturation_1( "Desaturation_1", Float ) = 0.000000
		Tiling_2( "Tiling_2", Float ) = 1.000000
		ColorTint_2( "ColorTint_2", Color ) = (1.000000, 1.000000, 1.000000, 0.000000 )
		ColorBrightness_2( "ColorBrightness_2", Float ) = 1.000000
		Desaturation_2( "Desaturation_2", Float ) = 0.000000
		RoughnessInt_1( "RoughnessInt_1", Float ) = 1.000000
		Specular_1( "Specular_1", Float ) = 1.000000
		RoughnessInt_2( "RoughnessInt_2", Float ) = 1.000000
		Specular_2( "Specular_2", Float ) = 1.000000
