...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(1.000000,1.000000,1.000000,0.700000);//(Unknown)
	...
	Material.PreshaderBuffer[2].w = Brightness;
	Material.PreshaderBuffer[3].x = MetalicAmount;
	Material.PreshaderBuffer[3].y = SpecularValue;
	Material.PreshaderBuffer[3].z = Roughness;
	Material.PreshaderBuffer[3].w = OpacityInt;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local11 = (Local10 * ((MaterialFloat3)Material.PreshaderBuffer[2].w));
	MaterialFloat Local12 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local13 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias);
	MaterialFloat Local14 = MaterialStoreTexSample(Parameters, Local13, 0);
	MaterialFloat Local15 = (Local13.g * Material.PreshaderBuffer[3].x);
	MaterialFloat Local16 = (Local13.r * Material.PreshaderBuffer[3].y);
	MaterialFloat Local17 = (Local13.b * Material.PreshaderBuffer[3].z);
	MaterialFloat Local18 = (Local13.a * Material.PreshaderBuffer[3].w);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local18;
