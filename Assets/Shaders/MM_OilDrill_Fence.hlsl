...
uniform float4 Fence_TilingOffset;
...
{
	Material.PreshaderBuffer[0] = float4(1.000000,1.000000,0.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[0].xy = Append(Fence_TilingOffset.x, Fence_TilingOffset.y);
	Material.PreshaderBuffer[0].zw = Append(Fence_TilingOffset.z, Fence_TilingOffset.w);
	Material.PreshaderBuffer[1].x = NormalIntensity;
	Material.PreshaderBuffer[1].y = SelectionColor.w;
	...
	Material.PreshaderBuffer[4].y = SpecularIntensity;
	Material.PreshaderBuffer[4].z = Roughness_Strength;
	Material.PreshaderBuffer[4].w = Roughness_Contrast;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local1 = (DERIV_BASE_VALUE(Local0) * Material.PreshaderBuffer[0].xy);
	MaterialFloat2 Local2 = (DERIV_BASE_VALUE(Local1) + Material.PreshaderBuffer[0].zw);
	...
	MaterialFloat2 Local6 = (Local4.rgb.rg * ((MaterialFloat2)Material.PreshaderBuffer[1].x));
	...
	MaterialFloat3 Local7 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].y);
	...
	MaterialFloat3 Local12 = lerp(Local9.rgb,((MaterialFloat3)Local11),Material.PreshaderBuffer[2].w);
	MaterialFloat3 Local13 = (Local12 * ((MaterialFloat3)Material.PreshaderBuffer[3].x));
	MaterialFloat3 Local14 = (Local13 * Material.PreshaderBuffer[3].yzw);
	MaterialFloat3 Local15 = PositiveClampedPow(Local14,((MaterialFloat3)Material.PreshaderBuffer[4].x));
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 0);
	MaterialFloat4 Local17 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias);
	MaterialFloat Local18 = MaterialStoreTexSample(Parameters, Local17, 0);
	MaterialFloat Local19 = (Local17.r * Material.PreshaderBuffer[4].y);
	MaterialFloat Local20 = lerp(Local19,0.50000000,Local17.g);
	MaterialFloat Local21 = (Local17.b * Material.PreshaderBuffer[4].z);
	MaterialFloat Local22 = PositiveClampedPow(Local21,Material.PreshaderBuffer[4].w);

	PixelMaterialInputs.EmissiveColor = Local7;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local17.a;
	PixelMaterialInputs.BaseColor = Local15;
	PixelMaterialInputs.Metallic = Local17.g;
