Shader "Unreal/MI_Pavement_1"
{
    Properties
    {
		...
		Tint( "Tint", Vector ) = (0.416667, 0.398418, 0.367180, 1.000000 )
		MetalicAmount( "MetalicAmount", Float ) = 0.000000
		Puddle_02_Specular( "Puddle_02_Specular", Float ) = 5.000000
		Puddle_02_Roughness( "Puddle_02_Roughness", Float ) = 0.000000
