...
uniform float BaseColor_Desaturation;
uniform float Specular_Control;
uniform float Roughness_Control;
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[0].x = FlattenNormal;
	Material.PreshaderBuffer[0].y = SelectionColor.w;
	Material.PreshaderBuffer[1].xyz = SelectionColor.xyz;
	Material.PreshaderBuffer[1].w = BaseColor_Desaturation;
	Material.PreshaderBuffer[2].x = Brightness;
	Material.PreshaderBuffer[2].y = Specular_Control;
	Material.PreshaderBuffer[2].z = Roughness_Control;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local11 = (((MaterialFloat3)Material.PreshaderBuffer[2].x) * Local10);
	MaterialFloat Local12 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local13 = Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias);
	MaterialFloat Local14 = MaterialStoreTexSample(Parameters, Local13, 0);
	MaterialFloat Local15 = (Local13.r * Material.PreshaderBuffer[2].y);
	MaterialFloat Local16 = (Local13.g * Material.PreshaderBuffer[2].z);
	...
	PixelMaterialInputs.Specular = Local15;
