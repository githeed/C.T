...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[0].x = LineWidth;
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local1 = DERIV_BASE_VALUE(Local0).g;
	MaterialFloat Local2 = ddx((float)DERIV_BASE_VALUE(Local1));
	MaterialFloat Local3 = (DERIV_BASE_VALUE(Local2) * Material.PreshaderBuffer[0].x);
	MaterialFloat Local4 = (DERIV_BASE_VALUE(Local1) + DERIV_BASE_VALUE(Local3));
	MaterialFloat Local5 = ddy((float)DERIV_BASE_VALUE(Local1));
	MaterialFloat Local6 = (DERIV_BASE_VALUE(Local5) * Material.PreshaderBuffer[0].x);
	MaterialFloat Local7 = (DERIV_BASE_VALUE(Local4) + DERIV_BASE_VALUE(Local6));
	MaterialFloat Local8 = floor(DERIV_BASE_VALUE(Local7));
	MaterialFloat Local9 = (DERIV_BASE_VALUE(Local1) - DERIV_BASE_VALUE(Local3));
	MaterialFloat Local10 = (DERIV_BASE_VALUE(Local9) - DERIV_BASE_VALUE(Local6));
	MaterialFloat Local11 = floor(DERIV_BASE_VALUE(Local10));
	MaterialFloat Local12 = (Local8 - Local11);
	MaterialFloat Local13 = abs(Local12);
	MaterialFloat Local14 = (DERIV_BASE_VALUE(Local9) + DERIV_BASE_VALUE(Local6));
	MaterialFloat Local15 = floor(DERIV_BASE_VALUE(Local14));
	MaterialFloat Local16 = (DERIV_BASE_VALUE(Local4) - DERIV_BASE_VALUE(Local6));
	MaterialFloat Local17 = floor(DERIV_BASE_VALUE(Local16));
	MaterialFloat Local18 = (Local15 - Local17);
	MaterialFloat Local19 = abs(Local18);
	MaterialFloat Local20 = max(DERIV_BASE_VALUE(Local13),DERIV_BASE_VALUE(Local19));
	MaterialFloat Local21 = select((DERIV_BASE_VALUE(Local20) >= 1.00000000), 1.00000000, 0.15000001);
	MaterialFloat3 Local22 = (MaterialFloat3(0.34999999,0.89999998,0.00000000).rgb * ((MaterialFloat3)Local21));
	MaterialFloat3 Local23 = lerp(Local22,Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[0].y);
