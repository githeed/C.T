Shader "Unreal/MI_DryPlants_02"
{
    Properties
    {
		...
		ColorTint( "ColorTint", Color ) = (1.000000, 0.824724, 0.270759, 0.000000 )
		ColorBrightness( "ColorBrightness", Float ) = 1.000000
		Desaturation( "Desaturation", Float ) = 0.350000
		RoughnessInt( "RoughnessInt", Float ) = 1.000000
		Specular_19( "Specular_19", Float ) = 1.000000
		SS_Amount( "SS_Amount", Float ) = 0.833249
