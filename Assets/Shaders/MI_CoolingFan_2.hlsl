...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.067112,0.067708,0.025715,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[2].xyz = Color_11.xyz;
	...
	Material.PreshaderBuffer[4].w = OpacityInt;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local22 = (Local17.a * Material.PreshaderBuffer[4].w);

	PixelMaterialInputs.EmissiveColor = Local6;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local22;
