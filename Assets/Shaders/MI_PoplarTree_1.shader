Shader "Unreal/MI_PoplarTree_1"
{
    Properties
    {
		...
		Material_Texture2D_0( "NAOR", 2D ) = "white" {}
		Material_Texture2D_1( "BCO", 2D ) = "white" {}
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		Tiling( "Tiling", Float ) = 1.000000
		NormalStrength( "NormalStrength", Float ) = 2.000000
		U_Offset( "U_Offset", Float ) = 0.000000
		V_Offset( "V_Offset", Float ) = 0.000000
		ColorTint( "ColorTint", Color ) = (1.000000, 1.000000, 1.000000, 0.000000 )
		ColorBrightness( "ColorBrightness", Float ) = 0.409524
		Desaturation( "Desaturation", Float ) = 0.300000
		RoughnessInt( "RoughnessInt", Float ) = 1.044984
		Specular_18( "Specular_18", Float ) = -2.848443
		SS_Amount( "SS_Amount", Float ) = 0.110582
		Alpha_1( "Alpha_1", Float ) = 1.000000
		Alpha_2( "Alpha_2", Float ) = 1.000000
		OpacityInt( "OpacityInt", Float ) = 4.000000
		SSBrightness( "SSBrightness", Float ) = 1.000000
		__SubsurfaceProfile( "__SubsurfaceProfile", Float ) = -1.000000
		AO( "AO", Float ) = 0.500000
